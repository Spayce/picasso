...
final class MarkableInputStream extends InputStream {
    ...
    public MarkableInputStream(InputStream in, final int size) {
        if (!in.markSupported()) {
     ...
     */
    public long savePosition(final int readLimit) {
        final long offsetLimit = offset + readLimit;
     ...
     */
    public void reset(final long token) throws IOException {
     ...
     */
    private void skip(long current, final long target) throws IOException {
    ...
    public int read(final byte[] buffer, final int offset, final int length) throws IOException {
        final int count = in.read(buffer, offset, length);
        if (count != -1) {
            this.offset += count;
        }
        return count;
    ...
    public long skip(final long byteCount) throws IOException {
        final long skipped = in.skip(byteCount);
        offset += skipped;
        return skipped;
    }
