...
class ContactsPhotoBitmapHunter extends BitmapHunter {
    ...
    ContactsPhotoBitmapHunter(final Context context, final Picasso picasso, final Dispatcher dispatcher, final Cache cache,
    ...
    private Bitmap decodeStream(final InputStream stream, final Request data) throws IOException {
        if (stream == null) {
            return null;
        }
